...
export function AdminEmployeeDetail({ dataStore, employeeId, onNavigate, initialTab }: AdminEmployeeDetailProps) {
 ...
 <EmployeeInvestigationTable
 rows={investigationsReportedBy}
 emptyMessage="No investigations initiated from reports filed by this employee."
 ...
 <EmployeeInvestigationTable
 rows={investigationsAgainst}
 emptyMessage="No investigations where this employee is the subject."
 users={dataStore.users}
 onNavigate={onNavigate}
 />
 </section>
 ...
 <EmployeeInvestigationTable
 rows={investigationsWitness}
 emptyMessage="No investigations where this employee is listed as a witness."
 users={dataStore.users}
 onNavigate={onNavigate}
 />
 </section>
