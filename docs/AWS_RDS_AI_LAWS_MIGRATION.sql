-- =============================================================================
-- MISMO — AI HR Law Monitor + Outreach Coach (PostgreSQL migration)
-- Run AFTER AWS_RDS_POSTGRES_SCHEMA.sql
-- =============================================================================
...
-- AWS NOTES
-- =============================================================================
-- HR_LAW_SYNC Lambda (weekly EventBridge): research states → upsert hr_law_records
--   → diff content_hash → insert hr_law_updates → enqueue notifications
-- OUTREACH_COACH Lambda (API Gateway): POST /ai/outreach/coach → outreach_coach_sessions
-- OPENAI_API_KEY in Secrets Manager; never in frontend env
-- Optional: OpenAI Vector Store per jurisdiction for RAG over hr_law_records.full_text
-- =============================================================================
